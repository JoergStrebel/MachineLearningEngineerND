...
# create tasks
task_train = Task(market_train, 1500.0, 120000.0, ['SP500', 'ESTOXX','MSCI'], 'SP500')
task_test = Task(market_test, 1500.0, 120000.0, ['SP500', 'ESTOXX','MSCI'], 'SP500')
dateTimeObj = datetime.now()
timestampStr = dateTimeObj.strftime("%d-%b-%Y_%H%M%S")

num_episodes = 1  # no training required
...
agent = BAH_Agent(task_train, task_test, monthly_allocation)
